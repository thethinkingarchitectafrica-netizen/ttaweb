  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (imageFile) {
        ...
        imageUrl = await uploadFile(imageFile, "media", path);
      }
      ...
      await logAction("create_team_member", formData.name);
    ...
    <div className="flex flex-col gap-10">
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col gap-1">
          <h1 className="heading-1 text-4xl">Add Team Member</h1>
          <p className="small-text opacity-40 uppercase tracking-widest text-[10px]">Grow the core team</p>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-8">
          <div className="glass-card p-10 flex flex-col gap-6">
               ...
               >
                 {imagePreview ? (
                   ...
                   <>
                     ...
                     <span className="text-[10px] opacity-40 text-center px-4">Upload Photo</span>
                     <input 
                       type="file" 
                       accept="image/*" 
            ...
            <div className="flex flex-col gap-2">
              ...
              />
              <p className="text-[10px] opacity-30">Lower numbers appear first.</p>
            </div>
          </div>
          ...
          >
            <Save size={20} />
            <span>{loading ? "Saving..." : "Add Member"}</span>
          </button>
        </div>
      </form>
    </div>
